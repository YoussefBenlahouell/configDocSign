...
export function passwordIncludeName(
  firstName: string,
  lastName: string,
  password: string
) {
  return (formGroup: FormGroup) => {
    ...
    const included =
      passwordContorl.value.includes(fName.value) ||
      passwordContorl.value.includes(lName.value);
...
export function passchecker(controlname: string, controlcompare: string) {
  return (formGroup: FormGroup) => {
