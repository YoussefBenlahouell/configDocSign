...
const routes: Routes = [
  ...
  },
  {
    path: "signature",
    loadChildren: () =>
        import("../app/signature/signature.module").then((m) => m.SignatureModule),
  },
  {
    path: "template",
    data: { roles: ["MEMBER"] },
  ...
  { path: "", redirectTo: "dashbord", pathMatch: "full" }, // Route par défaut
  { path: "**", redirectTo: "dashbord" }, // Fallback
];
